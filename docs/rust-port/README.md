...
> **Go behavior oracle:** commit `0c7cf695c881385265c846d5e51fb9be9e1b20f3`, release reference `post-v0.12.2-security-855`; VALUE baselines remain pinned to `ae863319` / `v0.12.2`
