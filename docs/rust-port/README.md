...
- [`value001-order-bias-repair.md`](value001-order-bias-repair.md) — schema-4 order-stratified decision contract and fail-closed boundary.
...
and provenance. Only schema 4 can approve a current candidate. It requires
...
schema-4 decision input. Missing, mismatched, or materially unbalanced
