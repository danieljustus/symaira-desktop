...
> **Go behavior oracle:** commit `136f01570944af16c4bc447b7eb63d03125aac3f`, release reference `post-v0.12.2-security-855`; VALUE baselines remain pinned to `ae863319` / `v0.12.2`
