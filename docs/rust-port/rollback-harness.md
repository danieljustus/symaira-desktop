...
No installed executable, existing room, vault, identity store, or user data is
opened. Build dependencies may be fetched by Cargo or Go into temporary caches.
