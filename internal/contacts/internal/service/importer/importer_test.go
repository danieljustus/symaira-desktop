...
import (
	...
	contactdomain "github.com/danieljustus/symaira-desktop/internal/contacts/internal/domain/contact"
	importerdomain "github.com/danieljustus/symaira-desktop/internal/contacts/internal/domain/importer"
	contactsvc "github.com/danieljustus/symaira-desktop/internal/contacts/internal/service/contact"
	"github.com/danieljustus/symaira-desktop/internal/contacts/internal/storage/sqlite"
)
...
func repoRoot(t *testing.T) string {
	...
	// internal/contacts/internal/service/importer -> repo root
...
func TestPlan_DryRunNeverWrites(t *testing.T) {
	...
	f, err := os.Open(filepath.Join(repoRoot(t), "relate", "testdata", "import", "sample.vcf"))
	if err != nil {
...
func TestApply_InvalidRowsNeverReachTheDatabase(t *testing.T) {
	...
	f, err := os.Open(filepath.Join(repoRoot(t), "relate", "testdata", "import", "sample.csv"))
	if err != nil {
		t.Fatalf("open fixture error = %v", err)
	}
	defer func() { _ = f.Close() }()
