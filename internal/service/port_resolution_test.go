...
func TestVaultResolutionInventory(t *testing.T) {
	...
	fixture := resolutionFixture{SchemaVersion: 1, Oracle: inventory.Oracle{Commit: "026a886ef3c6b0a50ff86963abb714f34ebc5840", Release: "post-v0.12.2-security-855"}, Documents: documents, Nodes: graph.Nodes, Edges: graph.Edges}
