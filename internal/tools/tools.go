...
func NewRegistry(options RegistryOptions) *Registry {
	...
	entries := []Tool{
		...
		entry(true, newDatasetListTool(options.GetService)),
		entry(true, newDatasetDescribeTool(options.GetService)),
		entry(true, newDatasetQueryTool(options.GetService)),
		entry(false, newDatasetSyncTool(options.GetService)),
