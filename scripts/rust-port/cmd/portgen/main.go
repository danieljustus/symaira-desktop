...
func runGenerate(repoRoot, commit, release string) {
	...
	packages := []struct {
		...
		{"./internal/room/run", "^TestPortRunCLIContract$"},
		{"./internal/history", "^TestPortHistoryPurgeContract$"},
		{"./internal/service", "^TestPortDataset(SyncContract|SyncServiceContract|ImportContract)$"},
